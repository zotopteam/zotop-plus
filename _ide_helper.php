...
')
     ...
     */
        ...
        public static function all()
        {
                        /** @var \Zotop\Modules\Repository $instance */
                        return $instance->all();
        }
                    /**
         * 获取启用或者禁用的模块
        ...
        public static function macro($name, $macro)
        {
                        \Zotop\Modules\Repository::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Zotop\Modules\Repository::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Zotop\Modules\Repository::hasMacro($name);
        }
                    /**
         * Dynamically handle calls to the class.
         *
    ...
    namespace Zotop\Themes\Facades {
            /**
     *
     *
     */
        ...
        public static function all()
        {
                        /** @var \Zotop\Themes\Repository $instance */
                        return $instance->all();
        }
                    /**
         * 获取特定类型的主题
        ...
        public static function macro($name, $macro)
        {
                        \Zotop\Themes\Repository::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Zotop\Themes\Repository::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Zotop\Themes\Repository::hasMacro($name);
        }
                    /**
         * Dynamically handle calls to the class.
         *
