...
<div class="main">
    ...
    <div class="main-body scrollable">
        ...
        <table class="table table-nowrap table-sortable table-hover">
            <thead>
                <tr>
                    <td class="drag"></td>
                    <td>{{trans('region::module.state.label')}}</td>
                    <td>{{trans('region::module.name.label')}}</td>
                </tr>
            </thead>        
            <tbody>  
            @foreach($regions as $region)
                <tr class="item {{$region->disabled ? 'disabled' : 'active'}}">
                	...
                	<td>
                        ...
                        <div class="manage">
                            <a href="{{route('region.index', $region->id)}}" class="manage-item"><i class="fa fa-sitemap"></i> {{trans('region::module.child')}}</a>
    ...
    <div class="main-footer">
        <div class="footer-text mr-auto">
            <i class="fa fa-circle-o fa-fw text-primary"></i> {{trans('region::module.description')}}
        </div>
    </div>
</div>
@endsection
