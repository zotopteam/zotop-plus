 ...
 * 一键排版插件
 *
 * @modified by hankx_chen 2015年12月14日
 */
...
(function() {
	...
	tinymce.create('tinymce.plugins.OneKeyClearPlugin',{
		init : function(ed,url) {
			//允许的标签项
			allowTags = ['p','div','a','img','embed','iframe','br','b','strong','span','pagebreak','gffy','ul','ol','dl','li','dd','dt','table','tbody','thead','tr','th','td','h1','h2','h3','h4','h5','h6','blockquote','pre','sub','sup'];
			//验证的正则
			tagPatrn = /<\s*([\/]?)\s*([\w]+)[^>]*>/ig;
			...
			ed.addCommand('mceOneKeyClear',function() {
				...
				//删除允许范围之外的标签
				htmlContent = htmlContent.replace(/<p class="mce-pagebreak">/ig,'<pagebreak>');
				...
				htmlContent = htmlContent.replace(/<pagebreak>/ig,'<p class="mce-pagebreak">');
