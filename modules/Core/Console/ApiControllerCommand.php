...
class ApiControllerCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'module:make-api-controller 
                            {controller : The name of the front controller class.} 
                            {module : The name of module will be used.} 
                            {--style=simple : The style of controller.} 
     ...
     * @var string
     */
    protected $description = 'Generate new api controller for the module.';
    ...
    protected function getDestinationFilePath()
    {
        ...
        return $path . 'Http/Controllers/Api/' . $this->getControllerName() . '.php';
    }
    ...
    private function getStubName()
    {
        ...
        return "/api-controller-{$style}.stub";
    }
    ...
    private function getViewFiles()
    {
        ...
        $path = $this->laravel['modules']->getModulePath('core'). 'Console/stubs/views/api-controller/'.$style;
    ...
    private function getViewPath($file='')
    {
        ...
        $path = $path . 'Resources/views/api/'.$this->getLowerControllerName().'/';
