            ...
            <div class="container-fluid">
                ...
                <z-form bind="$role" route="['core.role.update',$id]" method="PUT" id="role" autocomplete="off">
                    ...
                    <div class="form-group row">
                        <label for="name"
                               class="col-2 col-form-label required">{{trans('core::role.name.label')}}</label>
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        <label for="description"
                               class="col-2 col-form-label required">{{trans('core::role.description.label')}}</label>
                        <div class="col-8">
                    ...
                    <div class="form-title row">
                        ...
                        <div class="col-8 p-0">
                            <a href="javascript:;" class="btn btn-success btn-sm mr-3 select-all"
                               data-select="select-all">{{trans('core::role.select.all')}}</a>
                            <a href="javascript:;" class="btn btn-warning btn-sm  mr-3 select-none"
                               data-select="select-none">{{trans('core::role.select.none')}}</a>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    @foreach ($module['permissions'] as $key=>$val)
                                                ...
                                                <div class="role-group-body">
                                                    @foreach ($val as $k=>$v)
                                                        <div class="d-inline-block">
                                                            <z-field type="checkbox" name="permissions[]" id="$k"
                                                                     value="$k" data-module="$m" label="trans($v)"/>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
                                        @else
                                            <div class="col-auto">
                                                <div class="d-inline-block">
                                                    <z-field type="checkbox" name="permissions[]" id="$key" value="$key"
                                                             data-module="$m" label="trans($val)"/>
                                                </div>
                                            </div>
                                        @endif
                                    @endforeach
