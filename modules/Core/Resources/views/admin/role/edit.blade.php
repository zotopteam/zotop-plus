...
<div class="main">
    ...
    <div class="main-body scrollable">
        <div class="container-fluid">
            ...
            {form model="$role" route="['core.role.update',$id]" method="PUT" id="role" autocomplete="off"}
            ...
            <div class="form-group row">
                <label class="col-2 checkbox">
                    {field type="checkbox" name="permissions[]" value="$module['key']" data-type="module" data-module="$m"}
                    ...
                    <div class="row">
                        <div class="col-2">
                            <label class="checkbox">
                                {field type="checkbox" name="permissions[]" value="$controller['key']" data-type="controller" data-module="$m" data-controller="$c"}
                        ...
                        <div class="col-10">
                            ...
                            <label class="checkbox">
                                {field type="checkbox" name="permissions[]" value="$action['key']" data-type="action" data-module="$m" data-controller="$c" data-action="$a"}
