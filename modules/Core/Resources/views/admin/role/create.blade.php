...
<div class="main">
    ...
    <div class="main-body scrollable">
        <div class="container-fluid">
            ...
            <z-form bind="$role" route="core.role.store" method="post" id="role" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 role-group mb-2">
                            ...
                            @foreach ($val as $k=>$v)
                                ...
                                <z-field type="checkbox" name="permissions[]" id="$k" value="$k" data-module="$m" label="trans($v)"/>
                                </div>
                            @endforeach
                            </div>
                        </div>
