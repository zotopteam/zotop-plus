...
<div class="main">
    <div class="main-header">        
        ...
        <div class="main-action">
          <a href="{{route('core.role.create')}}" class="btn btn-primary"> <i class="fa fa-plus"></i> {{trans('master.create')}}</a>
        </div>           
    </div>
                ...
                @foreach($roles as $role)
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="manage">
                                <a class="manage-item" href="{{route('core.role.edit', $role->id)}}"><i class="fa fa-edit"></i> {{trans('master.edit')}}</a>
                                ...
                                <a class="manage-item js-delete" href="javascript:;" data-url="{{route('core.role.destroy', $role->id)}}"><i class="fa fa-times"></i> {{trans('master.delete')}}</a>
                            </div>
