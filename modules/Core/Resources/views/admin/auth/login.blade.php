...
@section('content')
    <section class="d-flex justify-content-center full-height">
        <z-form route="admin.login" method="post" class="form-login align-self-center" autocomplete="off"
            ...
            <div class="card card-login">
                <div class="card-header bg-primary text-white text-center pos-r">
                    ...
                    <svg class="animation-wave" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <z-field type="text" name="username" required="required" autofocus="autofocus"
                                     placeholder="trans('core::auth.account.placeholder')"
                                     data-msg-required="trans('core::auth.account.required')"/>
                            <div class="input-group-append" title="{{trans('core::auth.remember')}}"
                                 data-toggle="tooltip" data-placement="right">
                                <div class="input-group-text">
                                    <input type="checkbox" class="form-control text-muted text-md" name="remember"
                                           tabindex="-1" {{ old('remember') ? 'checked' : ''}}>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        <div class="input-group input-group-merge">
                            ...
                            <z-field type="password" name="password" required="required"
                                     placeholder="trans('core::auth.password.placeholder')"
                                     data-msg-required="trans('core::auth.password.required')"/>
                        </div>
                    ...
                    <div class="form-group">
                        <z-field type="submit" value="trans('core::auth.submit')" icon=""
                                 class="btn-block"/>
                    </div>
                </div>
            </div>
