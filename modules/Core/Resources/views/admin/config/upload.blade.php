            ...
            <div class="container-fluid">
                ...
                <z-form bind="$config" route="core.config.upload" method="post" id="config" autocomplete="off">
                            ...
                            <div class="form-control">
                                <table class="table table-inside table-nowrap table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th width="12%"
                                            class="text-center">{{trans('core::config.upload.types.enabled')}}
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach (Module::data('core::file.types') as $type=>$name)
                                        <tr>
                                            <td>{{$name}}</td>
                                            <td>
                                                <z-field type="text" name="upload[types]['.$type.'][extensions]"/>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    <z-field type="number" name="upload[types]['.$type.'][maxsize]"
                                                             min="0"
                                                             required/>
                                            ...
                                            <td class="text-center">
                                                <z-field type="toggle"
                                                         name="upload[types]['.$type.'][enabled]"/>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <z-field type="radiogroup" column="1" name="upload[dir]"
                                     options="Module::data('core::upload.dir')"/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-5">
                            <div class="input-group">
                                <div class="input-group-prepend"><span
                                            class="input-group-text">{{trans('core::image.watermark.width')}}</span>
                                </div>
                                <z-field type="number" name="image[watermark][width]" min="0"/>
                                <div class="input-group-prepend"><span
                                            class="input-group-text">{{trans('core::image.watermark.height')}}</span>
                                </div>
                    ...
                    <div class="watermark-options" rel="text" data-depend="#watermark-type :radio"
                         data-when="value=text"
                         data-then="show">
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <div class="input-group input-color">
                                    <div class="input-group-prepend"><span
                                                class="input-group-text">{{trans('core::image.watermark.font.color')}}</span>
                                    </div>
                            ...
                            <div class="col-3">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span
                                                class="input-group-text">{{trans('core::image.watermark.font.angle')}}</span>
                                    </div>
                    ...
                    <div class="watermark-options" rel="image" data-depend="#watermark-type :radio"
                         data-when="value=image"
                         data-then="show">
                        <div class="form-group row">
                                ...
                                <table class="table table-nowrap ">
                                    ...
                                    <tr>
                                        @foreach (Module::data('core::watermark.position') as $value=>$postion)
                                            <td class="text-center">
                                                <z-field type="radio" name="image[watermark][position]" id="$value"
                                                         value="$value"
                                                         label="$postion"/>
                                            </td>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-5">
                            <div class="input-group">
                                <div class="input-group-prepend"><span
                                            class="input-group-text">{{trans('core::image.watermark.offset.x')}}</span>
                                </div>
                                <z-field type="number" name="image[watermark][offset_x]" min="0"/>
                                <div class="input-group-prepend"><span
                                            class="input-group-text">{{trans('core::image.watermark.offset.y')}}</span>
                                </div>
