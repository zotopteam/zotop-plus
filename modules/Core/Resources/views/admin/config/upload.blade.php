...
<div class="main">
    ...
    <div class="main-body scrollable">
        <div class="container-fluid">
                ...
                <div class="col-8">
                    ...
                    <table class="table table-nowrap form-control">
                        ...
                        <tbody> 
                            ...
                            <tr>
                                <td>{{trans('core::config.upload.type.'.$type)}}</td>
                    ...
                    {field type="upload_image" name="test" required="required"}
                </div>
            </div>
            ...
            <div class="form-title row">{{trans('core::config.image.resize')}}</div>
            
            <div class="form-group row">
                <label for="resize_enabled" class="col-2 col-form-label">{{trans('core::config.image.resize.enabled')}}</label>
                <div class="col-8">
            ...
            <div class="form-group row">
                <label for="resize_max" class="col-2 col-form-label">{{trans('core::config.image.resize.max')}}</label>
                <div class="col-5">
                    <div class="input-group">
                        <div class="input-group-addon">{{trans('core::config.image.resize.width')}}</div>
                        {field type="number" name="image[resize][width]" min="0"}
                        <div class="input-group-addon">{{trans('core::config.image.resize.height')}}</div>
                        {field type="number" name="image[resize][width]" min="0"}
                    ...
                    @else
                    <span class="form-help">{{trans('core::config.image.resize.max.help')}}</span>
                    @endif
                </div>
            </div>
            ...
            <div class="form-group row">
                <label for="resize_quality" class="col-2 col-form-label">
                    {{trans('core::config.image.resize.quality')}}
                </label>
                <div class="col-5">
                    ...
                    @else
                    <span class="form-help">{{trans('core::config.image.resize.quality.help')}}</span>
                    @endif
                </div>
            </div>
            <div class="form-title row">{{trans('core::config.image.watermark')}}</div>
            
            <div class="form-group row">
                <label for="watermark_enabled" class="col-2 col-form-label">
                    {{trans('core::config.image.watermark.enabled')}}
                </label>
                <div class="col-8">
            ...
            <div class="form-group row">
                <label for="watermark_min" class="col-2 col-form-label">{{trans('core::config.image.watermark.min')}}</label>
                <div class="col-5">
                    <div class="input-group">
                        <div class="input-group-addon">{{trans('core::config.image.watermark.width')}}</div>
                        {field type="number" name="image[watermark][width]" min="0"}
                        <div class="input-group-addon">{{trans('core::config.image.watermark.height')}}</div>
                        {field type="number" name="image[watermark][width]" min="0"}
                        <div class="input-group-addon">px</div>
                    </div>
                    ...
                    @else
                    <span class="form-help">{{trans('core::config.image.watermark.min.help')}}</span>
                    @endif
                </div>
            </div>

            <div class="form-group row">
                <label for="watermark_type" class="col-2 col-form-label">
                    {{trans('core::config.image.watermark.type')}}
                </label>
                <div class="col-5">
            ...
            <div class="form-group row">
                <label for="watermark_font" class="col-2 col-form-label">
                    {{trans('core::config.image.watermark.font')}}
                </label>
                <div class="col-8">
                     {field type="radiocards" name="image[watermark][font]" options="Module::data('core::watermark.font')"}
                </div>
            </div>
