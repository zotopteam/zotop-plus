...
return [
    ...
    'reboot'                                 => '重启',
    'reboot.title'                           => '重启系统',
    'reboot.description'                     => '重启系统将会根据运行环境清理或者自动生成配置和路由缓存等数据',
    ...
    'config.cache.description'               => '缓存配置将加快系统运行速度，但是修改配置文件后需要重新缓存配置才能生效，生产环境建议缓存',
    'route.cache.title'                      => '路由缓存',
    'route.cache.description'                => '缓存路由将加快系统运行速度，但是修改路由文件后需要重新缓存路由才能生效，生产环境建议缓存',
    ...
    'debugbar.clear.title'                   => '清理调试信息',
    'debugbar.clear.description'             => '清理调试中产生的信息，可以放心清理',    
];
