    ...
    <table class="table table-sm table-sortable table-nowrap table-hover table-border table-fields">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="fields[{{$k}}][label]" class="form-control form-control-sm text required"
                        value="{{$v['label']}}" placeholder="{{trans('block::block.fields.label.placeholder')}}">
                </td>
                <td>
                    @if ($v['show'] == 2)
                    <input type="text" class="form-control form-control-sm text" value="{{$v['name']}}" disabled>
                    <input type="hidden" name="fields[{{$k}}][name]" class="form-control required"
                        value="{{$v['name']}}" placeholder="{{trans('block::block.fields.name.placeholder')}}"
                        fieldname="true" uniquename="true">
                    @else
                    <input type="text" name="fields[{{$k}}][name]" class="form-control form-control-sm required"
                        value="{{$v['name']}}" placeholder="{{trans('block::block.fields.name.placeholder')}}"
                        fieldname="true" uniquename="true">
                    @endif
                </td>
                <td class="text-center">
                    ...
                    @else
                    <input type="checkbox" name="fields[{{$k}}][required]" value="required" @if(isset($v['required']) &&
                        $v['required'])checked="checked" @endif>
                    @endif
                </td>
                <td>
                    @if ($v['show'] == 2)
                ...
                <td class="field-settings">
                    ...
                    <div class="input-group input-group-sm">
                        <div class="input-group-prepend"><span
                                class="input-group-text">{{trans('block::block.fields.length')}}</span></div>
                        <input type="number" name="fields[{{$k}}][minlength]" class="form-control required"
                            value="{{$v['minlength'] ?? 0}}">
                        <div class="input-group-prepend"><span class="input-group-text">-</span></div>
                        <input type="number" name="fields[{{$k}}][maxlength]" class="form-control required"
                            value="{{$v['maxlength'] ?? 255}}">
                        <div class="input-group-append"><span
                                class="input-group-text">{{trans('block::block.fields.length.unit')}}</span></div>
                    </div>
                    @endif
                    ...
                    <div class="input-group input-group-sm">
                        <div class="input-group-prepend"><span
                                class="input-group-text">{{trans('block::block.fields.size')}}</span></div>
                        <select name="fields[{{$k}}][resize][type]" class="form-control"
                            id="field-settings-type-{{$k}}">
                    ...
                    <div class="field-settings-more">
                        ...
                        <div class="input-group input-group-sm my-2" data-depend="#field-settings-type-{{$k}}"
                            data-when="value=thunmb,crop" data-then="show">
                            <div class="input-group-prepend"><span
                                    class="input-group-text">{{trans('block::block.fields.width_height')}}</span></div>
                            <input type="number" name="fields[{{$k}}][resize][width]" class="form-control required"
                                value="{{$v['resize']['width'] ?? ''}}">
                            <div class="input-group-prepend"><span class="input-group-text">-</span></div>
                            <input type="number" name="fields[{{$k}}][resize][height]" class="form-control required"
                                value="{{$v['resize']['height'] ?? ''}}">
                            <div class="input-group-append"><span class="input-group-text">px</span></div>
                        </div>

                        <div class="input-group input-group-sm my-2">
                            <div class="input-group-prepend"><span
                                    class="input-group-text">{{trans('block::block.fields.watermark')}}</span></div>
                    ...
                    <div class="field-settings-more">
                        <div class="input-group input-group-sm my-2">
                            <div class="input-group-prepend"><span
                                    class="input-group-text">{{trans('block::block.fields.rows')}}</span></div>
                            <input type="number" name="fields[{{$k}}][rows]" class="form-control required"
                                value="{{$v['rows'] ?? 3}}">
                        </div>
                    </div>
                    @endif
                ...
                <td>
                    <input type="text" name="fields[{{$k}}][placeholder]" class="form-control form-control-sm"
                        value="{{$v['placeholder'] ?? ''}}">
                </td>
            </tr>
            @endforeach
...
<style type="text/css">
    ...
    .table-fields tr:hover .field-settings-more {
        display: block;
    }
</style>
<script>
