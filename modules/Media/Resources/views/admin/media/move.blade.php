...
<div class="main">
    <div class="main-header">
        @if($keywords = request('keywords'))
            <div class="main-back">
                <a href="{{route('media.move',[$parent->id ?? 0])}}"><i class="fa fa-angle-left"></i><b>{{trans('core::master.back')}}</b></a>
            </div>           
...
$(function(){
    // statusbar
    $dialog.statusbar('{{trans('media::media.move.help')}}');

    // 设置当前所在的节点编号
    $dialog.parent_id = {{$parent->id ?? 0}};
})
</script>
@endpush
