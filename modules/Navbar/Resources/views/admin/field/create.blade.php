    ...
    <div class="main">
        <div class="main-header">
            ...
            <nav class="breadcrumb mr-auto">
                ...
                @endif
                <a class="breadcrumb-item"
                   href="{{route('navbar.item.index', ['navbar_id'=>$navbar_id, 'parent_id'=>$parent_id])}}">
        ...
        <div class="main-body scrollable">
            <div class="container-fluid">
                ...
                <z-form bind="$field" route="navbar.field.store" method="post" id="form-field" autocomplete="off">
