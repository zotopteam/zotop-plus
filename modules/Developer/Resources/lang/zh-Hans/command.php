...
return [
    ...
    'filter.title'            => 'QueryFilter 模型滤器',
    'filter.help'             => '',
    'filter.name.label'       => '名称',
    'filter.name.help'        => '输入名称会自动转换为变种驼峰命名，如：test=>TestFilter，test_abc=>TestAbcFilter',
    'filter.table.label'      => 'Table 名称',
    'filter.table.help'       => '滤器关联的数据表，如果不填写，将生成空滤器，当表存在时，自动生成表字段的对应滤器',
    ...
    'request.table.label'     => '数据表',
    'request.table.help'      => '如果不填将生成空白请求验证，当填写时，自动生成表字段对应的请求验证',
    'request.type.label'      => '类型',
    'request.type.help'       => '',
    ...
    'control.title'           => 'Control 表单控件',
    'control.help'            => '需要在当前模块的ServiceProvider的boot方法中注册组件后才能使用',
    'control.name.label'      => '控件名称',
    'control.name.help'       => '输入名称会自动转换为变种驼峰命名，如：test=>Test，test-abc=>TestAbc',
    'control.view.label'      => '控件视图',
    'control.view.help'       => '不选择视图将创建内联视图控件',
    'control.view.backend'    => '后端视图',
    'control.view.frontend'   => '前端视图',
    'enum.title'              => 'Enum 枚举',
    'enum.help'               => '',
    'enum.name.label'         => '名称',
    'enum.name.help'          => '输入名称会自动转换为变种驼峰命名，如：test=>TestEnum，test_abc=>TestAbcEnum',
];
