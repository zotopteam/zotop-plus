...
return [
    ...
    'controller_plain.label' => '控制器类型',
    'controller_plain.help'  => '不同控制器类型默认创建的控制器和模板不同',
    'controller_plain.true'  => '基本控制器，只含Index动作和对应模板',
    'controller_plain.false' => '资源控制器，包含Index/Create/Update/Destory 等动作和对应模板',    
