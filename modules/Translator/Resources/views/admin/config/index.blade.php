...
<div class="main">
    ...
    <div class="container-fluid scrollable">
            <z-form bind="$config" route="translator.config.index" method="post" id="config" autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <z-field type="select" name="engine" options="Module::data('translator::engines')" required="required"/>
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <div class="input-group">
                        ...
                        <z-field type="select" name="from" options="Module::data('translator::languages')" required="required"/>
                        <div class="input-group-prepend"><span class="input-group-text">{{trans('translator::config.to')}}</span></div>
                        <z-field type="select" name="to" options="Module::data('translator::languages')" required="required"/>
                    </div>
            ...
            <div class="engine d-none" data-depend="[name=engine]" data-when="value=baidu" data-then="show">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <z-field type="text" name="baidu[appid]" required="required"/>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <z-field type="text" name="baidu[secretkey]" required="required"/>
                    </div>
                </div>
            </div>
            ...
            <div class="engine d-none" class="engine" data-depend="[name=engine]" data-when="value=youdao" data-then="show">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <z-field type="text" name="youdao[appid]" required="required"/>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <z-field type="text" name="youdao[secretkey]" required="required"/>
                    </div>
                </div>
            </div>
