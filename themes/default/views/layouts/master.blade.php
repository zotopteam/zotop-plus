            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form class="form-inline ml-auto" action="{{route('content.search')}}">
                    <div class="input-group">
                        <input class="form-control bg-light" type="search" name="keywords"
                               value="{{request('keywords')}}" placeholder="Search" aria-label="Search"
                               required="required">
                        <div class="input-group-append">
                            <button class="btn btn-light" type="submit"><i class="fa fa-search text-primary"></i>
                            </button>
                        </div>
                    </div>
                </form>
